...
def get_cfgs():
    env_cfg = {
        ...
        "safe_force": {
            ...
            "left_wheel_joint": 6.0, #给大点，测试的时候可以小
    ...
    curriculum_cfg = {
        ...
        "curriculum_ang_vel_min_range":0.5,   #比例
        "lin_vel_err_range":[0.15,0.2],  #课程误差阈值
        "ang_vel_err_range":[0.32,0.36],  #课程误差阈值 连续曲线>方波>不波动
        "damping_descent":True,
        "dof_damping_descent":[0.5, 0.0, 0.001, 0.8],#[damping_max,damping_min,damping_step（比例）,damping_threshold（存活步数比例）]
    }
