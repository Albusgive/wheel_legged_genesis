...
def get_train_cfg(exp_name, max_iterations):
    ...
    train_cfg_dict = {
        ...
        "runner": {
            ...
            "num_steps_per_env": 40,    #每轮仿真多少step
...
def get_cfgs():
    ...
    command_cfg = {
        ...
        "ang_vel_range": [-4.712, 4.712],   #修改范围要调整奖励权重
        "height_target_range": [0.22 , 0.32],   #lower会导致跪地
    }
    # 课程学习，奖励循序渐进 待优化
    curriculum_cfg = {
        "curriculum_lin_vel_step":0.002,   #比例
        "curriculum_ang_vel_step":0.0002,   #比例
        ...
        "lin_vel_err_range":[0.15,0.25],  #课程误差阈值
        "ang_vel_err_range":[0.3,0.35],  #课程误差阈值 连续曲线>方波>不波动
        "damping_descent":True,
        "dof_damping_descent":[0.2, 0.005, 0.0004, 0.9],#[damping_max,damping_min,damping_step（比例）,damping_threshold（存活步数比例）]
    }
